              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start notification -->
                    <a href="#">
                      <i class="fa fa-users text-aqua"></i></a>
                  </li>
                  <!-- end notification -->
                </ul>
              </li>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="#">
            <i class=""></i> <span>Ke Anggotaan</span>
            <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url(); ?>admin/Anggota">Data Anggota</a></li>
          </ul>
        </li>
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url();?>admin/Buku/buku"></i>Data Buku</a></li>
            <li><a href="<?php echo base_url(); ?>admin/Kategori"></i>Data Kategori</a></li>
             <li><a href="<?php echo base_url(); ?>admin/Rak"></i>Data Rak</a></li>
             <li><a href="<?php echo base_url(); ?>admin/Pengarang"></i>Data Pengarang</a></li>
              <li><a href="<?php echo base_url(); ?>admin/Penerbit"></i>Data Penerbit</a></li>
             <li><a href="<?php echo base_url(); ?>admin/Provinsi"></i>Data Provinsi</a></li>
          </ul>
        </li>
        <li class="header">TRANSAKSI</li>
         <li class="treeview">
          ...
          <ul class="treeview-menu">
              <li><a href="<?php echo base_url(); ?>admin/Pinjam"></i>Data Peminjaman</a></li>
              <!--li><a href="<?php echo base_url(); ?>admin/transaksi/pengembalian"><i class="fa fa-book"></i>Data Pengembalian</a></-->
          </ul>
        </li>
         <li class="treeview">
          <a href="#">
            </i> <span>Pengembalian</span>
            <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
              <li><a href="<?php echo base_url(); ?>admin/Report/pengembalian"></i>Data Pengembalian</a></li>
          </ul>

          <li class="treeview">
          <a href="#">
            <i ></i> <span>E Book</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
              ...
              <li><a href="https://ebookduniakesehatan.wordpress.com/2015/05/24/ebook-kesehatan-masyarakat/"></i>Kesehatan</a></li>
              <li><a href="<?php echo base_url(); ?>admin/Report/pengembalian"></i>Umum</a></li>
              <li><a href="http://ppb.upi.edu/category/ebook/"></i>Psokologi</a></li>
              <li><a href="https://www.researchgate.net/publication/304748841_BUKU_PENGANTAR_MANAJEMEN"></i>Manajement</a></li>
              <li><a href="https://www.researchgate.net/publication/304748835_BUKU_TEORI_EKONOMI"></i>Ekonomi</a></li>
          </ul>
        </li>
