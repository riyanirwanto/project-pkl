  ...
  <div class="btn-group">
    <td>
     <div align ="left">
      ...
      <a  href="<?php echo base_url(); ?>petugas/pinjam/vw_kembali"  class="btn btn-danger" role="button" data-toggle="tooltip" title="Kembali"></i>Kembali</a>
      </div>
   </td>
  </div>
  </div>
   ...
   foreach ($data_anggota->result_array() as $key => $value) {
     if ($value['id_anggota']== $value1['id_anggota']) {
      // echo $value['id_kelas'];
       foreach ($kelas->result_array() as $key => $kelas1) {
         # code...
        if($kelas1['id_kelas']==$value['id_kelas'])
          echo $kelas1['kelas'];
       }
     }
   }?>
    ...
    ?>
            <tr>
                ...
                <?php echo 
                    ...
                    {
                     echo 
                     '&nbsp<a href="'.base_url().'petugas/Pinjam/edit_pinjam/?id_pinjam='.$op['id_pinjam'].'" class="btn btn-warning" role="button" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>';
                      if ($op['total_buku']>0) {
                      echo 
                      '&nbsp<a href="'.base_url().'petugas/Kembali/?id_pinjam='.$op['id_pinjam'].'" class="btn btn-warning" role="button" data-toggle="tooltip" title="Kembalikan"><i class="fa fa-share"></i></a>';
                      }
                    }
                    if($op['status']==1){
                    echo 
                    '&nbsp<span data-toggle="modal" data-target="#confirm-delete" data-href="'.base_url().'admin/Pinjam/hapus_pinjam/?id_pinjam='.$op['id_pinjam'].'">
